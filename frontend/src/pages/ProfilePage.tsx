          ...
          <div className="mt-6 space-y-6 rounded-2xl border border-slate-200 bg-white p-5">
            {!profile ? (
              ...
              <>
                ...
                <section>
                  <div className="mb-2 flex items-center justify-between">
                    <h2 className="text-base font-bold text-slate-900">Domains</h2>
                  ...
                  <div className="mt-3 flex gap-2">
                    <input value={newDomain} onChange={(e) => setNewDomain(e.target.value)} placeholder="Add domain" className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm" />
