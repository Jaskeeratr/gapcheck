    ...
    <div className="space-y-6">
      ...
      <section className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
        {features.map((feature) => (
          <article key={feature.title} className="gc-panel rounded-3xl p-5">
        ...
        <article className="gc-panel rounded-3xl p-6">
          ...
          <div className="mt-5 grid gap-2 sm:grid-cols-2">
            {architectureLayers.map((layer) => (
              <div key={layer} className="rounded-xl border border-blue-100 bg-blue-50 px-3 py-3 text-sm font-bold text-blue-900">{layer}</div>
            ))}
          </div>
        </article>
        ...
        <article className="gc-panel rounded-3xl p-6">
          ...
          <div className="mt-4 flex snap-x gap-4 overflow-x-auto pb-2">
            {screenshots.map((screenshot) => (
              <div key={screenshot} className="min-w-[260px] snap-start rounded-2xl border border-dashed border-blue-200 bg-gradient-to-br from-blue-50 to-cyan-50 p-4 sm:min-w-[320px]">
